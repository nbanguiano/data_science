...
%
% Note: This is a simplified version of the SMO algorithm for training SVMs. In practice, if you want to train an SVM classifier, we recommend using an optimized package such as:  
%
...
% 
% We have implemented optimized vectorized version of the Kernels here so that the svm training will run faster.
